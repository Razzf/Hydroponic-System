...
void UpdatePh4() //function for setting up Ph4 constant
{
  delay(50);
...
void UpdatePh7() //function for setting up Ph7 constant
{
  delay(50);
...
void UpdatePh10() //function for setting up Ph10 constantn
{
  delay(50);
